...
class Portal extends TagLib
{
    ...
    protected $tags = [
        ...
        'articles'         => ['attr' => 'field,where,limit,order,pagetype, page,relation,returnVarName,pageVarName,categoryIds', 'close' => 1],//非必须属性item
    ...
    public function tagArticles($tag, $content)
    {
        ...
        $pagetype         = empty($tag['pagetype']) ? '1' : $tag['pagetype'];
