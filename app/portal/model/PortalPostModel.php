...
class PortalPostModel extends Model
{
    ...
    /**
     * survey_starttime 自动完成
     * @param $value
     * @return false|int
     */
     public function setSurveyStarttimeAttr($value)
     {
         return strtotime($value);
     }
     /**
      ...
      * @return false|int
      */
     public function setSurveyEndtimeAttr($value)
     {
         return strtotime($value);
     }
     ...
     * @param array|string $categories 问卷分类 id
     * @return $this
     */
    public function adminAddSurvey($data, $categories)
    {
        $data['user_id'] = cmf_get_current_admin_id();
